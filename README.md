...
What kind of music instruments do you want to buy, guitar, amplifier or pedal?
```
#### After you insert a valid word, the programme will show you all the products of this type and ask "which one do you wanna buy?". Here you can use ↑ and ↓ select the product and use Enter to choose.  
```
What kind of music instruments do you want to buy, guitar, amplifier or pedal?
guitar
tele: $1600
...
stra: $1443
maton: $1899
Which one do you want? (Press ↑/↓ arrow to move and Enter to select)
‣ tele
  gibson sg
  stra
  maton
```
#### After choosing, the programme will show the price of the product again and ask you whether you wanna buy more. If you insert y, the shopping process will start again.  
```
Which one do you want? gibson sg
The gibson sg is 2336.0 dollars.
Do you want to buy other products? Yes
+---------------+--------------+--------------+
|Guitar         |Amplifier     |Pedal         |
+---------------+--------------+--------------+
|tele: 1600     |fishman: 650  |overdrive: 216|
...
What kind of music instruments do you want to buy, guitar, amplifier or pedal?
```
#### If you choose n, the total money will be added together and shown by the programme. Then, The programme will ask you whether you are a student of Code Academy. If you are, there will be a big discount on the final payment.  
```
Totally 2524.0 dollar, are you a student of Code Academy? Yes
Thank you, the totally price is 2019.2, cash or card?
```
#### If not, the total money is same.  
```
Totally 2336.0 dollar, are you a student of Code Academy? no
Thank you, the totally price is 2336.0, cash or card?
```
#### Then, the programme will ask the payment method, if you choose card, everything gonna easy. You just need to tap and the programme will say bye to you.  
```
Please tap here.
Thank you for your coming and have a good day.
```
#### If you choose cash, the programme will let you insert money. If the money is not enough, it will be saved and then the programme will let you insert more money until the total money you insert is equal to or greater than the money you need to pay. Finally, the programme will say goodbye to you.
```
Thank you, the totally price is 1154.4, cash or card?
cash
Please insert money. (insert a number) 100
...
How much money do you want to insert?
1000
Please check your changes, 178.6 dollar.
Thank you for your coming and have a good day.
```
# Project Mnagement
...
![Exceptional Handling](/docs/Screen%20Shot%202022-04-18%20at%2009.29.07.png#pic_center)  
...
3. ***'colorize'***  
   I used gem of ***'colorize'*** to change the color of the text and the logo.   
   ![result of colorize](/docs/Screen%20Shot%202022-04-17%20at%2019.53.16.png#pic_center)
...
![Exceptional Handling](/docs/Screen%20Shot%202022-04-17%20at%2020.18.43.png#pic_center)  
